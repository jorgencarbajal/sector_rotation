...
`fetch.py`
- Three functions: fetch_and_store_ticker, fetch_and_store_fred, and store_rows. This file is mainly for fetching and storing raw data into the SQLite database.

`features.py`
- Here we start building all the features that are necessary for the training/test
- `build_mom_feature` is for 